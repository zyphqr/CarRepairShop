    ...
    public class RepairCardsController : Controller
    {
                                    ...
                                    decimal price)
        {
            ...
            return View("Views/RepairCards/Create.cshtml", new CreateEditRepairCardVM
            {
                ...
                SelectedRegistration = cars.ToList()[0].CarRegistration,
        ...
        public async Task<IActionResult> Create([Bind("RepairCardId,StartDate,EndDate,CarRegistration,Description,Price,TypeOfRepair,MechanicId")] RepairCard repairCard)
        {
            if (ModelState.IsValid)
            {
                _context.Add(repairCard);
